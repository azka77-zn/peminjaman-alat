...
// Halaman utama otomatis dialihkan ke halaman login jika diakses
Route::get('/', function () {
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // CRUD Peminjaman (SUDAH DIPINDAHKAN KE DALAM GROUP ADMIN AGAR MENJADI admin.peminjaman.*)
   // CRUD Peminjaman
