...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
        ...
        <div class="p-5 border-b border-gray-200 bg-gray-50">
            <h3 class="text-base font-bold text-gray-700">Menunggu Verifikasi Persetujuan</h3>
            ...
            <form action="{{ route('petugas.peminjaman.index') }}" method="GET" class="flex w-full md:w-80">
                ...
                <button type="submit"
                    class="ml-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition shadow-sm">
                    Cari
                </button>
