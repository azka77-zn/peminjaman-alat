...
<div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
        ...
        <form action="{{ route('petugas.pengembalian.index') }}" method="GET" class="flex w-full md:w-80">
            <input type="text" name="search" id="search" placeholder="Cari nama peminjam..."
                class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500">
            <button type="submit"
                class="ml-2 bg-gray-300 hover:bg-gray-700 text-gray-700 px-3 py-2 text-sm rounded-lg flex items-center transition">
                Reset
            </button>
        </form>
    </div>
                    ...
                    <td class="py-3 px-4 border-b text-center">
                        <form action="{{ route('petugas.pengembalian.proses', $item->id) }}" method="POST"
                            ...
                            <div>
                                ...
                                <select name="kondisi_kembali" required class="w-full text-sm border border-gray-300 rounded px-2 py-1">
                            ...
                            <div>
                                ...
                                <input type="number" name="denda" value="0" placeholder="0"
                                    class="w-full text-sm border border-gray-300 rounded px-2 py-1 focus:ring-emerald-500 focus:border-emerald-500">
                            </div>
                            <div>
